...
$_lang['nutshellmodx.form.error.nofields'] = 'No fields configured for NutshellModx. 
Please configure the FormIt parameter `nutshellFields`.';
$_lang['nutshellmodx.form.error.noemail'] = 'No contact email field configured for NutshellModx. 
